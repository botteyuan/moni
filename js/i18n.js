...
(function () {
  const STR = {
    cn: {
      ...
      'play.emuHintMd': '键盘：W/A/S/D 移动 · J=A · K=B · L=C · 逗号(,)=连发A · M=连发B · 句号(.)=连发C · I=开始 · U=选择；右上角菜单可存读档 / 设置 / 全屏。',
    ...
    en: {
      ...
      'play.emuHintMd': 'Keys: W/A/S/D = move · J = A · K = B · L = C · ,(comma) = turbo A · M = turbo B · .(period) = turbo C · I = Start · U = Select. Top-right menu for save/load/settings/fullscreen.',
